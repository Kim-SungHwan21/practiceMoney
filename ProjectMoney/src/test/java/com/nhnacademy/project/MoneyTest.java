...
class MoneyTest {
    ...
    @Test
    void add() {
        Money m1 = MoneyService.won(BigDecimal.valueOf(1_000));
        Money m2 = MoneyService.won(BigDecimal.valueOf(1_000));
    ...
    void add_5dollarPlus5dollar() {
        Money m1 = MoneyService.dollar(BigDecimal.valueOf(5.25));
        Money m2 = MoneyService.dollar(BigDecimal.valueOf(5.25));
    ...
    void add_notMatchedCurrency_throwInvalidCurrencyException() {
        Money m1 = MoneyService.dollar(BigDecimal.valueOf(5));
        Money m2 = MoneyService.won(BigDecimal.valueOf(5_000));
    ...
    void subtract_negative_throwException() {
        Money m1 = MoneyService.dollar(BigDecimal.valueOf(5));
        Money m2 = MoneyService.dollar(BigDecimal.valueOf(6));
    ...
    void subtract() {
        Money m1 = MoneyService.dollar(BigDecimal.valueOf(5));
        Money m2 = MoneyService.dollar(BigDecimal.valueOf(4));

        Money result = m1.substract(m2);

        assertThat(result).isEqualTo(MoneyService.dollar(BigDecimal.valueOf(1)));
    }
    ...
    @Test
    void exchange() {
        Money m1 = MoneyService.dollar(BigDecimal.valueOf(1));
        Money m2 = MoneyService.won(BigDecimal.valueOf(1_000));

        if(m1.equals(MoneyService.dollar(BigDecimal.valueOf(1)))) {
            m1 = MoneyService.won(BigDecimal.valueOf(1_000));

        }
        assertThat(m1.getAmount()).isEqualTo(m2.getAmount());
        assertThat(m1.getCurrency()).isEqualTo(m2.getCurrency());

        if(m2 == MoneyService.won(BigDecimal.valueOf(1_000))) {
            m2 = MoneyService.dollar(BigDecimal.valueOf(1));
        }
    ...
    void exchange_dollar () {
        Money m1 = MoneyService.dollar(BigDecimal.valueOf(5.25));
        Money m2 = MoneyService.won(BigDecimal.valueOf(5_250));

        if(m1.equals(MoneyService.dollar(BigDecimal.valueOf(5.25)))) {
            m1 = MoneyService.won(BigDecimal.valueOf(5_250));
        }
        assertThat(m1.getAmount()).isEqualTo(m2.getAmount());
        assertThat(m1.getCurrency()).isEqualTo(m2.getCurrency());
    }
    ...
    @Test
    void exchange_euro () {
        Money m1 = MoneyService.euro(BigDecimal.valueOf(2));
        Money m2 = MoneyService.won(BigDecimal.valueOf(2_000));

        if(m1.equals(MoneyService.euro(BigDecimal.valueOf(2)))) {
            m1 = MoneyService.won(BigDecimal.valueOf(2_000));
        }
